...
5. Deploy to Minikube-Cluster.
   ...
   ```sh
     helm install unguard  oci://ghcr.io/dynatrace-oss/unguard/chart/unguard --version 0.8.0-1683552264 --set localDev.minikube.enabled=true --wait --namespace unguard --create-namespace
   ```
